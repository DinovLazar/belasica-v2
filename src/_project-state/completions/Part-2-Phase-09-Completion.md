...
- ✅ **PR opened; Vercel preview loads; routes 200.** [PR #18](https://github.com/DinovLazar/belasica-v2/pull/18) opened (marked partial). Vercel check SUCCESS; **all six routes return 200** on the preview (`https://belasica-v2-git-phase-209-content-i-1e8934-dinovlazars-projects.vercel.app`): `/`, `/arhiva`, `/statistika`, `/legendi`, `/za-nas`, `/kontakt`. Published photo count still **8**. Merge is Lazar's call (phase mid-flight), but the PR is safe to merge — tooling + docs, no runtime change.
