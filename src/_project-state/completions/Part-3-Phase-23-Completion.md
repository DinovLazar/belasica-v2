...
- ✅ **Images with a missing `alt`: 0** (of 1 929). Deliberate `alt=""`: **368**, against a baseline of 367 — the `+1` is the crest, which now renders on the styled 404 where the old default 404 had no chrome. Non-empty `alt`: **1 561**, unchanged.
